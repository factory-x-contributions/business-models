...
export default function Plan306090({ color = DEFAULT_COLOR, lang = 'de' }) {
  ...
  const thBase = { border: cellBorder, borderBottom: `2px solid ${color}`, background: 'var(--ifm-table-head-background, transparent)', color: 'var(--ifm-table-head-color, var(--ifm-font-color-base))', fontWeight: 'var(--ifm-table-head-font-weight, 700)', fontSize: '0.78rem', padding: '0.4rem 0.5rem', verticalAlign: 'middle' };
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse', tableLayout: 'auto', minWidth: 800 }}>
          <thead>
            <tr>
              ...
              <th style={{ ...thBase, width: '6%' }}>{L.col1}</th>
              <th style={{ ...thBase, width: '8%' }}>{L.col2}</th>
              <th style={{ ...thBase, width: '11%' }}>{L.col3}</th>
              <th style={{ ...thBase, width: '11%' }}>{L.col4}</th>
              <th style={{ ...thBase, width: '14%' }}>{L.col5}</th>
              <th style={{ ...thBase, width: '10%' }}>{L.col6}</th>
              <th style={{ ...thBase, width: '10%' }}>{L.col7}</th>
              <th style={{ ...thBase, width: '10%' }}>{L.col8}</th>
              <th style={{ ...thBase }}>{L.col9}</th>
            </tr>
          </thead>
          <tbody>
            {rows.map((row, i) => (
