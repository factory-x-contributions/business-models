...
sidebar_position: 1
keywords: [Workshop, Design Sprint, Hausbaulogik, Geschäftsmodell Workshop, Factory-X, 5-Tage-Workshop, Facilitierung]
---
...
<div style={{display: 'flex', flexDirection: 'column', gap: '0'}}>
  ...
  {/* Vorbereitung */}
  <a href="./preparation" style={{display: 'grid', gridTemplateColumns: '150px 1fr', borderBottom: '1px solid var(--ifm-color-emphasis-200)', textDecoration: 'none', color: 'inherit', transition: 'background 0.2s'}}>
  ...
  {/* Tag 1 - Blau */}
  <a href="./day-1-blue-room" style={{display: 'grid', gridTemplateColumns: '150px 1fr', borderBottom: '1px solid var(--ifm-color-emphasis-200)', textDecoration: 'none', color: 'inherit', transition: 'background 0.2s'}}>
  ...
  {/* Tag 2 - Rot */}
  <a href="./day-2-red-room" style={{display: 'grid', gridTemplateColumns: '150px 1fr', borderBottom: '1px solid var(--ifm-color-emphasis-200)', textDecoration: 'none', color: 'inherit', transition: 'background 0.2s'}}>
  ...
  {/* Tag 3 - Grün */}
  <a href="./day-3-green-room" style={{display: 'grid', gridTemplateColumns: '150px 1fr', borderBottom: '1px solid var(--ifm-color-emphasis-200)', textDecoration: 'none', color: 'inherit', transition: 'background 0.2s'}}>
  ...
  {/* Tag 4 - Gelb */}
  <a href="./day-4-yellow-room" style={{display: 'grid', gridTemplateColumns: '150px 1fr', borderBottom: '1px solid var(--ifm-color-emphasis-200)', textDecoration: 'none', color: 'inherit', transition: 'background 0.2s'}}>
  ...
  {/* Tag 5 - Abschluss */}
  <a href="./day-5-closing" style={{display: 'grid', gridTemplateColumns: '150px 1fr', textDecoration: 'none', color: 'inherit', transition: 'background 0.2s'}}>
...
<br>
  ...
  <Admonition type="tip" title="Hybride Workshop-Variante mit AI-Unterstützung">
...
So kombinieren Sie strukturierte Workshop-Arbeit mit intelligenter AI-Begleitung.
  ...
  <Admonition type="info" title="Flexible Reihenfolge">
