...
<QualityGate items={[
  'Ich kann die drei Preisbausteine des CMLS-Preismodells (Subscription, Variable, Setup Fee) benennen und erklären',
  'Ich kenne den modellhaften Break-even (~5 Maschinen) und verstehe, warum die Maschinenanzahl der stärkste Hebel ist',
  'Ich kann die Unit Economics (Erlös, Kosten, Deckungsbeitrag) für das 10-Maschinen-Szenario wiedergeben',
  'Ich verstehe die Preisstrategie: Argumentation über Stillstandskosten, nicht über Softwarepreis',
  'Ich kann das Kosten-Nutzen-Fazit für alle vier Akteure (Betreiber, Maschinenbauer, Partner, Operator) zusammenfassen',
]} />
