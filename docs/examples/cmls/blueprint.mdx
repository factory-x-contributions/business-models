...
<RoomHero
  ...
  color="#8b5cf6"
  heading="Value-Oriented Service Business Model (VSBM)"
...
<QualityGate items={[
  'Ich kann die 10 Kernelemente des CMLS Business Model Blueprints benennen',
  'Ich kenne die drei Phasen der Roadmap (Pilot → Skalierung → Industrialisierung) und ihre Go/No-Go-Kriterien',
  'Ich verstehe die drei Erfolgsfaktoren des VSBM (Datenqualität, Messbarkeit, Skalierung)',
  'Ich kann die Kernaussagen aus der realen Anwendung der Hausbaulogik auf CMLS wiedergeben',
  'Ich bin in der Lage, die Hausbaulogik auf eine eigene Geschäftsidee anzuwenden – Raum für Raum',
]} />
