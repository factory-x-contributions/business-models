...
<div style={{background: 'linear-gradient(135deg, rgba(196, 160, 0, 0.08) 0%, rgba(196, 160, 0, 0.02) 100%)', borderRadius: '8px', padding: '1.5rem', marginBottom: '2rem'}}>
  <div style={{display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '1rem'}}>
    ...
    <span style={{fontSize: '0.75rem', textTransform: 'uppercase', letterSpacing: '0.1em', color: '#C4A000', fontWeight: '600'}}>Gelber Raum</span>
  </div>
  ...
  <ul style={{margin: '0.75rem 0 0 0', paddingLeft: '1.25rem', fontSize: '1.05rem', color: 'var(--ifm-font-color-secondary)', lineHeight: '1.7'}}>
    ...
    <li>Welches Erlösmodell passt am besten?</li>
    <li>Wann erreichen wir die Gewinnzone?</li>
  </ul>
  <div style={{marginTop: '1.25rem', padding: '1rem 1.25rem', background: 'linear-gradient(135deg, rgba(196, 160, 0, 0.12) 0%, rgba(196, 160, 0, 0.04) 100%)', borderRadius: '8px', border: '1px solid rgba(196, 160, 0, 0.2)'}}>
    <div style={{display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '0.5rem'}}>
      ...
      <strong style={{color: '#C4A000', fontSize: '0.9rem', textTransform: 'uppercase', letterSpacing: '0.05em'}}>Ziel</strong>
    </div>
    <p style={{margin: 0, fontSize: '1rem', color: 'var(--ifm-font-color-secondary)', lineHeight: '1.6'}}>Dieser Abschnitt liefert eine <strong>validierte Wirtschaftlichkeitsanalyse</strong> mit Erlösmodell, Kostenstruktur und Business Case.</p>
  </div>
</div>
...
### Beispiel: Hybrid-Preismodell

| Komponente | Beschreibung | Preis |
|------------|--------------|-------|
| **A) Subscription** | Plattform, Monitoring, Basis-Analytics | X EUR/Maschine/Monat |
| **B) Variable** | Advanced Analytics, SLA-Stufen | Y EUR/Monat |
| **C) Setup Fee** | Integration, Onboarding | Z EUR einmalig |
...
<div style={{background: 'linear-gradient(135deg, rgba(107, 142, 80, 0.08) 0%, rgba(107, 142, 80, 0.03) 100%)', border: '1px solid rgba(107, 142, 80, 0.2)', borderRadius: '12px', padding: '1.25rem'}}>
  <h4 style={{margin: '0 0 0.5rem 0', color: '#6B8E50'}}>← Input aus Grünem Raum</h4>
...
<div style={{background: 'linear-gradient(135deg, rgba(107, 114, 128, 0.08) 0%, rgba(107, 114, 128, 0.03) 100%)', border: '1px solid rgba(107, 114, 128, 0.2)', borderRadius: '12px', padding: '1.25rem'}}>
  <h4 style={{margin: '0 0 0.5rem 0', color: '#6B7280'}}>Output für Ausgangsbereich →</h4>
  <ul style={{margin: 0, paddingLeft: '1.25rem', fontSize: '0.9rem'}}>
    <li>Validierte Wirtschaftlichkeit</li>
    <li>Business Case mit Break-even</li>
  </ul>
</div>
</div>
...
<div style={{border: '1px solid var(--ifm-color-emphasis-200)', borderRadius: '12px', padding: '1.25rem', background: 'var(--ifm-background-surface-color)'}}>
  ...
  <p style={{margin: 0, fontSize: '0.85rem', color: 'var(--ifm-font-color-secondary)'}}>Messbarer Kundennutzen mit KPIs</p>
</div>
...
<div style={{border: '1px solid var(--ifm-color-emphasis-200)', borderRadius: '12px', padding: '1.25rem', background: 'var(--ifm-background-surface-color)'}}>
  ...
  <h4 style={{margin: '0 0 0.25rem 0', fontSize: '0.95rem', fontWeight: '600'}}>Preismodell</h4>
  <p style={{margin: 0, fontSize: '0.85rem', color: 'var(--ifm-font-color-secondary)'}}>Erlösmodell, Preisstruktur, Positionierung</p>
</div>
...
<div style={{border: '1px solid var(--ifm-color-emphasis-200)', borderRadius: '12px', padding: '1.25rem', background: 'var(--ifm-background-surface-color)'}}>
  ...
  <p style={{margin: 0, fontSize: '0.85rem', color: 'var(--ifm-font-color-secondary)'}}>Alle Kostenblöcke mit Verhalten</p>
</div>
...
<div style={{border: '1px solid var(--ifm-color-emphasis-200)', borderRadius: '12px', padding: '1.25rem', background: 'var(--ifm-background-surface-color)'}}>
  ...
  <p style={{margin: 0, fontSize: '0.85rem', color: 'var(--ifm-font-color-secondary)'}}>Break-even, Szenarien, Sensitivität</p>
</div>
...
## Quality Gate: Gelber Raum

Bevor du in den Ausgangsbereich wechselst, prüfe:
...
<label style={{display: 'flex', alignItems: 'flex-start', gap: '0.75rem', marginBottom: '0.75rem', cursor: 'pointer'}}>
  ...
  <span>Wertquellen sind identifiziert und quantifiziert (EUR-Wert)</span>
</label>
<label style={{display: 'flex', alignItems: 'flex-start', gap: '0.75rem', marginBottom: '0.75rem', cursor: 'pointer'}}>
  <input type="checkbox" style={{marginTop: '0.25rem', width: '16px', height: '16px'}} />
  <span>KPIs zur Erfolgsmessung sind definiert</span>
</label>
<label style={{display: 'flex', alignItems: 'flex-start', gap: '0.75rem', marginBottom: '0.75rem', cursor: 'pointer'}}>
  <input type="checkbox" style={{marginTop: '0.25rem', width: '16px', height: '16px'}} />
  <span>Erlösmodell und Preisstruktur sind festgelegt</span>
</label>
<label style={{display: 'flex', alignItems: 'flex-start', gap: '0.75rem', marginBottom: '0.75rem', cursor: 'pointer'}}>
  <input type="checkbox" style={{marginTop: '0.25rem', width: '16px', height: '16px'}} />
  <span>Kostenstruktur ist vollständig dokumentiert</span>
</label>
<label style={{display: 'flex', alignItems: 'flex-start', gap: '0.75rem', cursor: 'pointer'}}>
  <input type="checkbox" style={{marginTop: '0.25rem', width: '16px', height: '16px'}} />
  <span>Break-even ist berechnet und Szenarien analysiert</span>
</label>
