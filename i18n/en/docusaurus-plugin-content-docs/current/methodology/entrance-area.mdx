...
The development of new revenue models (subscription, pay-per-use, outcome-based) takes place in the [Yellow Room](./yellow-room#2-revenue-mechanics--pricing-model).
</Admonition>
...
The precise definition of your role in the data space (Data Provider, Data Consumer, Service Provider, Orchestrator) as well as technical integration takes place in the [Green Room](./green-room#1-roles--actors).
</Admonition>
