...
sidebar_position: 1
keywords: [House-Building Logic, Business Model, Factory-X, data-driven business models, Business Model Canvas, Industry, Mechanical Engineering, Manufacturing-X]
---
...
<RoomHero
  ...
  label="Introduction"
  color="#386FB3"
  heading="Introduction to House-Building Logic"
  intro="The <strong>House-Building Logic (HBL)</strong> is a structured approach to developing data-driven business models – specifically designed for industrial contexts such as mechanical and plant engineering. Classic frameworks like the Business Model Canvas are often too abstract: They show which building blocks a business model has, but not how to develop them. The HBL solves this problem by providing a <strong>clear process with concrete methods</strong>."
  bullets={[
...
The rooms are color-coded and are traversed in a fixed sequence. Each room builds on the results of the previous one – at the end of each room is a **Quality Gate** that ensures all important questions are answered before moving on.
...
<div style={{ width: '100%', maxWidth: '480px', marginTop: '1.5rem', marginBottom: '2rem', marginLeft: 'auto', marginRight: 'auto' }}>
  ...
  <div style={{
    ...
    <div style={{
      ...
      <RoomButton
        href='./blue-room'
        text="Blue Room: Customer View"
        gradient="linear-gradient(135deg, #60a5fa 0%, #3b82f6 100%)"
        shadowColor="rgba(59, 130, 246, 0.15)"
        shadowColorHover="rgba(59, 130, 246, 0.3)"
        tooltip="Customer understanding: Who are they? What do they need?"
      />
      <RoomButton
        href='./red-room'
        text="Red Room: Value Proposition"
        gradient="linear-gradient(135deg, #f87171 0%, #ef4444 100%)"
        shadowColor="rgba(239, 68, 68, 0.15)"
        shadowColorHover="rgba(239, 68, 68, 0.3)"
        tooltip="Develop value proposition: What value do we offer?"
      />
      <RoomButton
        href='./green-room'
        text="Green Room: Value Creation"
        gradient="linear-gradient(135deg, #34d399 0%, #10b981 100%)"
        shadowColor="rgba(16, 185, 129, 0.15)"
        shadowColorHover="rgba(16, 185, 129, 0.3)"
        tooltip="Plan value creation: How do we create the value?"
      />
      <RoomButton
        href='./yellow-room'
        text="Yellow Room: Viability"
        gradient="linear-gradient(135deg, #fbbf24 0%, #f59e0b 100%)"
        shadowColor="rgba(245, 158, 11, 0.15)"
        shadowColorHover="rgba(245, 158, 11, 0.3)"
        tooltip="Check profitability: How do we make money?"
      />
    </div>
    ...
    <div style={{
      ...
      <RoomButton
        ...
        tooltip="Define business idea, set scope"
      />
      <RoomButton
        href='./exit-room'
        text="Exit"
        ...
        shadowColor="rgba(107, 114, 128, 0.15)"
        shadowColorHover="rgba(107, 114, 128, 0.3)"
        tooltip="Synthesis and decision: Go, Review, or Stop?"
      />
    </div>
...
<a href="../ai/single_prompt_guide" className="variant-card" style={{background: 'var(--ifm-background-surface-color)', border: '1px solid var(--ifm-color-emphasis-300)', borderRadius: '16px', padding: '1.5rem', position: 'relative', overflow: 'hidden', textDecoration: 'none', color: 'inherit', display: 'block', transition: 'transform 0.2s ease, box-shadow 0.2s ease, border-color 0.2s ease'}}>
  ...
  <p style={{fontSize: '0.9rem', color: 'var(--ifm-color-emphasis-700)'}}>Work independently with AI support. A chatbot or Agentic Skills guide you step by step through all rooms.</p>
  <ul style={{fontSize: '0.85rem', marginTop: '1rem'}}>
