...
<div style={{marginTop: '1rem', display: 'inline-block'}}>
  <GradientButton
    href="/files/ai/EN_BusinessModel_SinglePrompt.md"
    download="EN_BusinessModel_SinglePrompt.md"
    text="EN_BusinessModel_SinglePrompt.md"
...
The business model data you develop is sensitive. Preferably use company-internal chatbots that handle your data confidentially. See [Best Practices](./single_prompt_best_practices).
:::
