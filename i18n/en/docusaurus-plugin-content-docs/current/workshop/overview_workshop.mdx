...
sidebar_position: 1
keywords: [Workshop, Design Sprint, House Building Logic, Business Model Workshop, Factory-X, 5-Day Workshop, Facilitation]
---
...
<br>
  ...
  <Admonition type="tip" title="Hybrid Workshop Variant with AI Support">
This workshop can also be conducted **hybrid with AI support**. To do so:

1. First, set up the AI assistant **Estelle** - follow the [AI Assistant Setup Guide](../ai/single_prompt_guide)
2. On the respective **workshop day pages** you will find color-highlighted, concrete hints on how Estelle can support you with individual tasks

This way you combine structured workshop work with intelligent AI assistance.
  </Admonition>
