...
The workshop can be combined with the **[Business Model AI Assistant](../ai/ai_approaches)**. Sticky notes can be digitized and transferred to templates - this can reduce the time frame.
</Admonition>
